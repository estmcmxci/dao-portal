...
<Note> All Working Groups operated under the Working Group Rules, for more information, read the [ENS DAO Working Group Rules](https://docs.ens.domains/dao/wg/rules/).</Note>