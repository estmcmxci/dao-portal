...
The ENS DAO was created in November 2021 with the launch of the ENS Token, which serves as the governance token for the Ethereum Name Service (ENS) protocol.
